...
$string['pluginname'] = 'Профессиограмма'; // For tabs and menus...

$string['survey'] = 'Профессиограмма';
$string['surveys'] = 'Профессиограммы';
$string['Survey'] = 'Профессиограмма';
$string['Surveys'] = 'Профессиограммы';

$string['nosurveysaddone'] = 'Профессиограмма ещё не создана. %sДобавить опросник%s!';
...
$string['addsurvey'] = 'Добавить опрос';
$string['surveysettings'] = 'Настройки';
$string['completesurvey'] = 'Сохранить';
$string['backtosurveys'] = 'Вернуться';
$string['instructions'] = 'Пояснение';
$string['settings'] = 'Настройки';
$string['results'] = 'Результаты';
$string['noresults'] = 'Не содержит результатов.';
...
$string['chart'] = 'Графическое представление';
$string['comment'] = 'Comment...';

$string['selectsurvey'] = 'Выбрать опрос...';
$string['categorylanguage'] = 'по Соломину]';
...
$string['surveysettings'] = 'Настройки';
$string['surveytitle'] = 'Название';
$string['surveytitledesc'] = 'Выберите тестовый опрос для заполнения профессиограммы.';
$string['foreignlanguage'] = 'Язык';
$string['foreignlanguagedesc'] = 'Используйте эту функцию для перевода на свой язык';
...
$string['surveyanalysis'] = 'Скачать результаты';
...
$string['noaccessiblesurveys'] = 'невозможно анализировать до создания.';
...
$string['emptysurveyname'] = 'Не выбран опрос';
